execute as @e[tag=fairy] at @s anchored eyes facing entity @e[limit=1,sort=random] eyes positioned ^ ^ ^2 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^0.1 ^0.1 ~ ~
