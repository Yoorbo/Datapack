particle dust_color_transition 0.737 0.212 1.000 2 1.000 0.012 0.208 ~ ~0.5 ~ 0.4 0.4 0.4 0.4 4 force
...
execute as @e[type=!#guns:dont_target,type=!player,name=!BadlandsChugs,distance=..100] at @s run particle dust_color_transition 0.737 0.212 1.000 1 1.000 0.012 0.208 ^ ^1 ^0.3 0.4 0.6 0 0 10 force
