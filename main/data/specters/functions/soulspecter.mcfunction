...
execute as @e[tag=soulspecter] at @s anchored eyes run tp @e[distance=..4,type=!player,type=!arrow,type=!experience_orb,type=!item,type=!cow,type=!villager,type=!armor_stand,type=!pig,type=!bee,type=!hopper_minecart,type=!horse,type=!sheep,type=!cat,type=!sheep,type=!parrot,type=!wolf] ~ ~ ~
