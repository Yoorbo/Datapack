...
execute as @e[tag=soulspecter] at @s anchored eyes facing entity @e[tag=!soulgrabbed,tag=!soulzombie1,type=!player,type=!#guns:dont_target,distance=..50,limit=1,sort=random] eyes positioned ^ ^ ^2 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^0.4 ~ ~
execute as @e[tag=soulspecter] at @s anchored eyes run tp @e[distance=..4,type=!player,type=!#guns:dont_target,tag=!soulzombie1] ~ ~ ~
execute as @e[tag=soulspecter] at @s anchored eyes run tag @e[tag=!soulgrabbed,distance=..4,type=!player,type=!#guns:dont_target] add soulgrabbed
