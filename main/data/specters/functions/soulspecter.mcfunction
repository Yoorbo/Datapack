...
execute as @e[tag=soulspecter] at @s anchored eyes facing entity @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{soulcommander:1b}}}] eyes positioned ^ ^ ^2 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^0.4 ~ ~
execute as @e[tag=soulspecter] at @s anchored eyes facing entity @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{soulcommander:1b}}}] eyes positioned ^ ^ ^2 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^0.8 ~ ~
execute as @e[tag=soulspecter] at @s anchored eyes facing entity @e[tag=!soulgrabbed,type=!player,type=!arrow,type=!experience_orb,type=!item,type=!cow,type=!villager,type=!armor_stand,type=!pig,type=!bee,type=!hopper_minecart,type=!horse,type=!sheep,type=!cat,type=!sheep,type=!parrot,type=!wolf,distance=..150,limit=1,sort=nearest] eyes positioned ^ ^ ^2 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^0.2 ~ ~
