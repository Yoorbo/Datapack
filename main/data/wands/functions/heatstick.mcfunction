...
execute at @e[nbt={SelectedItem:{id:"minecraft:netherite_sword",tag:{soulsword:1b}}}] run effect give @e[distance=..6,type=!player,type=!arrow,tag=!soulzombie1,type=!experience_orb,type=!item,type=!cow,type=!villager,type=!armor_stand,type=!pig,type=!bee,type=!hopper_minecart,type=!horse,type=!sheep,type=!cat,type=!sheep,type=!parrot,type=!wolf,nbt=!{SelectedItem:{id:"minecraft:netherite_sword",tag:{soulsword:1b}}}] minecraft:wither 4 1 true
execute as @e[nbt={SelectedItem:{id:"minecraft:netherite_sword",tag:{soulsword:1b}}}] at @s run execute as @e[distance=..6,type=!item,tag=!soulzombie1,type=!arrow,type=!experience_orb,type=!minecart,type=!item_frame,type=!armor_stand] at @s run particle minecraft:ash ~ ~ ~ 0.4 0.4 0.4 0.15 10
execute as @e[nbt={SelectedItem:{id:"minecraft:netherite_sword",tag:{soulsword:1b}}}] at @s run execute as @e[distance=..6,type=!item,tag=!soulzombie1,type=!arrow,type=!experience_orb,type=!minecart,type=!item_frame,type=!armor_stand] at @s run particle minecraft:soul ~ ~0.3 ~ 0.4 0.4 0.4 0.01 1
execute as @e[nbt={SelectedItem:{id:"minecraft:netherite_sword",tag:{soulsword:1b}}}] at @s run execute as @e[distance=..6,type=!arrow,tag=!soulzombie1,type=!player,type=!experience_orb,type=!item,type=!armor_stand,type=!hopper_minecart,type=!minecart,type=!item_frame,type=!cow,type=!villager,type=!pig,type=!horse,type=!sheep,limit=2] at @s run tp @s ~ ~0.1 ~
execute as @e[nbt={SelectedItem:{id:"minecraft:netherite_sword",tag:{soulsword:1b}}}] at @s run execute as @e[distance=..6,type=!arrow,tag=!soulzombie1,type=!player,type=!experience_orb,type=!minecart,type=!item_frame,type=!armor_stand,type=!item,type=!cow,type=!hopper_minecart,type=!villager,type=!pig,type=!horse,type=!sheep,limit=1] at @s run playsound minecraft:block.conduit.ambient.short master @a
