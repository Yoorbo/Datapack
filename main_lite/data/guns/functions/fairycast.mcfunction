...
execute as @e[tag=!raycasting,tag=corrupted_fairy,dx=0] positioned ~-0.99 ~-0.99 ~-0.99 if entity @s[dx=0] positioned ~0.99 ~0.99 ~0.99 run function guns:fairycast_uncorrupt

scoreboard players add .distance fairy_raycast 1

particle dust_color_transition 0.737 0.212 1.000 1 1.000 0.012 0.208 ~ ~ ~ 0 0 0 0 0
